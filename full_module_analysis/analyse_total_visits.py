...
plot_stimulus_over_days(
    ...
    mice=mice,
    ymax=max_value,
    title="Visits per hour (Stimulus) - Males - single mice",
    ylabel="#visits",
    savename=f'{path}visits_per_hour_stim_males'
)
...
plot_stimulus_over_days(
    ...
    mice=mice,
    ymax=max_value,
    title="Visits per hour (Control) - Males - single mice",
    ylabel="#visits",
    savename=f'{path}visits_per_hour_con_males'
)