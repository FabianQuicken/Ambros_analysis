...
plot_stimulus_over_days(
    ...
    mice=mice,
    ymax=max_value,
    title="Food Interaction (Stimulus) - Males - single mice",
    ylabel="Time (%)",
    savename=f'{path}food_stim_males'
)
...
plot_stimulus_over_days(
    ...
    mice=mice,
    ymax=max_value,
    title="Food Interaction (Control) - Males - single mice",
    ylabel="Time (%)",
    savename=f'{path}food_con_males'
)