...
for mouse_data in data:
    for stats in mouse_data:
        all_data.append(stats.mean_visit_time)
...
for mouse_data in data:
    ...
    if len(mouse_data) == 8:
        if first_stim_modul == 1:
            hab1_stimulus_module_data.append(mouse_data[0].mean_visit_time)
            hab1_control_module_data.append(mouse_data[1].mean_visit_time)

            hab2_stimulus_module_data.append(mouse_data[4].mean_visit_time)
            hab2_control_module_data.append(mouse_data[5].mean_visit_time)
            
            exp1_stimulus_module_data.append(mouse_data[2].mean_visit_time)
            exp1_control_module_data.append(mouse_data[3].mean_visit_time)

            exp2_stimulus_module_data.append(mouse_data[7].mean_visit_time)
            exp2_control_module_data.append(mouse_data[6].mean_visit_time)


        elif first_stim_modul == 2:
            hab1_stimulus_module_data.append(mouse_data[1].mean_visit_time)
            hab1_control_module_data.append(mouse_data[0].mean_visit_time)

            hab2_stimulus_module_data.append(mouse_data[5].mean_visit_time)
            hab2_control_module_data.append(mouse_data[4].mean_visit_time)

            exp1_stimulus_module_data.append(mouse_data[3].mean_visit_time)
            exp1_control_module_data.append(mouse_data[2].mean_visit_time)  

            exp2_stimulus_module_data.append(mouse_data[6].mean_visit_time)
            exp2_control_module_data.append(mouse_data[7].mean_visit_time)
