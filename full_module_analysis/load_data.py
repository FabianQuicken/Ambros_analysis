...
from plotting import cumsum_plot_average
...
#print(exp1_stimulus_module_data)
#print(exp1_stimulus_module_data)

cumsum_plot_average(data_stim_modul=exp2_stimulus_module_data, data_con_modul=exp2_control_module_data, savename='')