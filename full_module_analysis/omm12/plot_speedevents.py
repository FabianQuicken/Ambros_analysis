...
rasterplot(
    ...
    color=None,
    stylemode="dark",
    savepath=r"Z:\n2023_odor_related_behavior\2025_omm_mice\Analysis4\rasterplot_hab_females.svg",
    ylabel=None,
    condition="hab",
    plotsize=(16, 9),
    fontsize=12,
...
rasterplot(
    ...
    color=None,
    stylemode="dark",
    savepath=r"Z:\n2023_odor_related_behavior\2025_omm_mice\Analysis4\rasterplot_hab_males.svg",
    ylabel=None,
    condition="hab",
    plotsize=(16, 9),
    fontsize=12,
...
rasterplot(
    ...
    color=None,
    stylemode="dark",
    savepath=r"Z:\n2023_odor_related_behavior\2025_omm_mice\Analysis4\rasterplot_top1_females.svg",
    ylabel=None,
    condition="top1",
    plotsize=(16, 9),
    fontsize=12,
...
rasterplot(
    ...
    color=None,
    stylemode="dark",
    savepath=r"Z:\n2023_odor_related_behavior\2025_omm_mice\Analysis4\rasterplot_top1_males.svg",
    ylabel=None,
    condition="top1",
    plotsize=(16, 9),
    fontsize=12,
...
rasterplot(
    ...
    color=None,
    stylemode="dark",
    savepath=r"Z:\n2023_odor_related_behavior\2025_omm_mice\Analysis4\rasterplot_top2_females.svg",
    ylabel=None,
    condition="top2",
    plotsize=(16, 9),
    fontsize=12,
...
rasterplot(
    ...
    color=None,
    stylemode="dark",
    savepath=r"Z:\n2023_odor_related_behavior\2025_omm_mice\Analysis4\rasterplot_top2_males.svg",
    ylabel=None,
    condition="top2",
    plotsize=(16, 9),
    fontsize=12,
