...
all_predictions = 3 * all_predictions_drinking + 2 * all_predictions_rear + all_predictions_groom
all_ground_truth = 3 * all_ground_truth_drinking + 2 * all_ground_truth_rear + all_ground_truth_groom
...
labels = ['background behavior', 'grooming', 'rearing', 'drinking']
...
ax.set_title('DEG confusion matrix', color='white')
...
plt.savefig(f"{project_path}/def_confusionmatrix.svg", format='svg', facecolor="black")
plt.show()